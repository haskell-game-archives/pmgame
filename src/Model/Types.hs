...
data Options = Options
  { _firstlevel :: Int, -- Where to start
...
data PacMan = PacMan
  { _pdir :: Direction, -- Current direction
...
data Ghost = Ghost
  { _gname :: GhostName, -- Name for the ghost
...
data Items = Items
  { _pellets :: Int, -- Normal pellets eaten
...
data Fruit = Fruit
  { _fname :: FruitName, -- Name for the fruit
...
--  in the powered mode.
data Mode
  = StartScreen -- Play has not begun
